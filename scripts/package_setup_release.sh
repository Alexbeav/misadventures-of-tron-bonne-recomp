...
#
# Writes: dist/misadventuresoftronbonne-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix misadventuresoftronbonne \
  --exe-name The_Misadventures_of_Tron_Bonne \
  --omit-openbios \
  --display-name "The Misadventures of Tron Bonne" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned The Misadventures of Tron Bonne (Europe) disc" \
  --runtime-dir mods \
