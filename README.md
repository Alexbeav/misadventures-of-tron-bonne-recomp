...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/misadventures-of-tron-bonne-recomp/total)](https://github.com/Alexbeav/misadventures-of-tron-bonne-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/misadventures-of-tron-bonne-recomp/latest/total)](https://github.com/Alexbeav/misadventures-of-tron-bonne-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/misadventures-of-tron-bonne-recomp)](https://github.com/Alexbeav/misadventures-of-tron-bonne-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **The Misadventures of Tron Bonne** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLES-02795 disc image
...
|---|---|
| Region | Europe |
| Disc serial | SLES-02795 |
| Discs | 1 |
| Supported dump | Redump `Misadventures of Tron Bonne, The (Europe).cue` as CUE/BIN or CHD |
| BIOS | SCPH-5552 (Europe), 524288 bytes, SHA-256 `1faaa18fa820a0225e488d9f086296b8e6c46df739666093987ff7d8fd352c09` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/misadventures-of-tron-bonne-recomp/releases)
   and extract it into a writable folder.
2. Start `The_Misadventures_of_Tron_Bonne` (`.exe` on Windows).
...
named `diagnostic-mode.txt` next to `The_Misadventures_of_Tron_Bonne.exe` and start the game as
usual, or run `The_Misadventures_of_Tron_Bonne.exe --diagnostic`. Reproduce the problem, quit, then
run `The_Misadventures_of_Tron_Bonne.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
